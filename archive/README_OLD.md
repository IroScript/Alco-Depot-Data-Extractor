...
- **Multi-depot support** - Process multiple depot databases at once
- **MPO codes from Excel** - Load MPO codes from external Excel file
...
- **Multi-Depot Processing**: Extract data from multiple depot databases simultaneously
...
- **Flexible MPO Filtering**: Use Excel file or pattern matching for MPO codes
...
This will:
- Load MPO codes from `mpo_code.xlsx`
- Scan `All_Depots/` folder for all depot databases
- Extract MPO-wise sales from each depot
- Combine data into single Excel report

**Output:**
- `All_Depots_MPO_Report_YYYYMMDD_HHMMSS.xlsx` with:
  - All Data (combined from all depots)
  - Depot Summary
  - MPO Summary

---

#### 2. Attach Your MDF Database
